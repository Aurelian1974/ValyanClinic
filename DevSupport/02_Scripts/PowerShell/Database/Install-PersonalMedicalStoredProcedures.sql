-- =============================================
-- COMBINED STORED PROCEDURES INSTALLATION SCRIPT
-- Install all PersonalMedical stored procedures in correct order
-- =============================================

PRINT '?? INSTALLING PERSONALMEDICAL STORED PROCEDURES'
PRINT '================================================='
...
BEGIN TRY
    ...
    -- =============================================
    PRINT ''
    PRINT '?? Installing: sp_PersonalMedical_GetAll'
    PRINT '--------------------------------------'
    ...
    PRINT '? sp_PersonalMedical_GetAll installed successfully'

    -- =============================================
    -- SP pentru obtinerea statisticilor personal medical
    -- =============================================
    PRINT ''
    PRINT '?? Installing: sp_PersonalMedical_GetStatistics'
    PRINT '--------------------------------------------'
    ...
    BEGIN
        ...
        SELECT 
            'Personal Medical Activ' as StatisticName,
            COUNT(*) as Value,
        ...
        SELECT 
            'Personal Medical Inactiv' as StatisticName,
            COUNT(*) as Value,
        ...
        SELECT 
            'Total Doctori' as StatisticName,
            COUNT(*) as Value,
        ...
        SELECT 
            'Total Asistenti' as StatisticName,
            COUNT(*) as Value,
        ...
        SELECT 
            'Total Tehniciani' as StatisticName,
            COUNT(*) as Value,
    ...
    PRINT '? sp_PersonalMedical_GetStatistics installed successfully'

    -- =============================================
    -- SP pentru obtinerea unui personal medical dupa ID
    -- =============================================
    PRINT ''
    PRINT '?? Installing: sp_PersonalMedical_GetById'
    PRINT '---------------------------------------'
    ...
    PRINT '? sp_PersonalMedical_GetById installed successfully'

    -- =============================================
    -- SP pentru verificarea unicit??ii Email ?i NumarLicenta
    -- =============================================
    PRINT ''
    PRINT '?? Installing: sp_PersonalMedical_CheckUnique'
    PRINT '------------------------------------------'
    ...
    PRINT '? sp_PersonalMedical_CheckUnique installed successfully'

    -- =============================================
    -- SP pentru crearea unui nou personal medical
    -- =============================================
    PRINT ''
    PRINT '?? Installing: sp_PersonalMedical_Create'
    PRINT '-------------------------------------'
    ...
    PRINT '? sp_PersonalMedical_Create installed successfully'

    -- =============================================
    -- SP pentru actualizarea unui personal medical
    -- =============================================
    PRINT ''
    PRINT '?? Installing: sp_PersonalMedical_Update'
    PRINT '-------------------------------------'
    ...
    PRINT '? sp_PersonalMedical_Update installed successfully'

    -- =============================================
    -- SP pentru stergerea unui personal medical (soft delete)
    -- =============================================
    PRINT ''
    PRINT '?? Installing: sp_PersonalMedical_Delete'
    PRINT '-------------------------------------'
    ...
    PRINT '? sp_PersonalMedical_Delete installed successfully'

    -- =============================================
    -- SP pentru obtinerea optiunilor pentru dropdown-uri
    -- =============================================
    PRINT ''
    PRINT '?? Installing: sp_PersonalMedical_GetDropdownOptions'
    PRINT '------------------------------------------------'
    ...
    PRINT '? sp_PersonalMedical_GetDropdownOptions installed successfully'

    PRINT ''
    PRINT '?? ALL PERSONALMEDICAL STORED PROCEDURES INSTALLED SUCCESSFULLY!'
    PRINT '=============================================================='
    PRINT 'Installation completed at: ' + CONVERT(VARCHAR, GETDATE(), 120)
    PRINT ''
    PRINT '?? INSTALLED PROCEDURES:'
    PRINT '   • sp_PersonalMedical_GetAll'
    PRINT '   • sp_PersonalMedical_GetStatistics'
    PRINT '   • sp_PersonalMedical_GetById'
    PRINT '   • sp_PersonalMedical_CheckUnique'
    PRINT '   • sp_PersonalMedical_Create'
    PRINT '   • sp_PersonalMedical_Update'
    PRINT '   • sp_PersonalMedical_Delete'
    PRINT '   • sp_PersonalMedical_GetDropdownOptions'
    PRINT ''
    PRINT '? Your PersonalMedical repository should now work correctly!'
...
BEGIN CATCH
    ...
    PRINT 'Error Line: ' + CAST(ERROR_LINE() AS VARCHAR(5))
    PRINT ''
