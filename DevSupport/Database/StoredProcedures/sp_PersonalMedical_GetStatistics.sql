-- ========================================
-- Stored Procedure: sp_PersonalMedical_GetStatistics
-- Database: ValyanMed
-- Created: 09/22/2025 20:33:10
-- Modified: 09/22/2025 20:33:10
...
-- =============================================
CREATE   PROCEDURE [dbo].[sp_PersonalMedical_GetStatistics]
AS
BEGIN
    SET NOCOUNT ON;
