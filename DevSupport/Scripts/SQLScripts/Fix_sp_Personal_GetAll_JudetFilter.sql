-- ============================================================================
-- FIX: sp_Personal_GetAll - Ad?ugare Filtru Jude?
-- Data: 2025-01-XX
-- Scop: Adaug? parametrul @Judet pentru filtrare dup? jude?
-- ============================================================================
...
-- ============================================================================
-- CREARE sp_Personal_GetCount cu suport pentru Judet
-- ============================================================================
...
PRINT '';
PRINT '?? Filtre disponibile:';
PRINT '   - GlobalSearchText (10 câmpuri)';
PRINT '   - Departament';
PRINT '   - Status';
PRINT '   - Functie';
PRINT '   - Judet ? NOU';
...
-- Test judet filter
PRINT '?? Testare filtru Judet:';
DECLARE @TestPageNumber INT = 1;
DECLARE @TestPageSize INT = 10;
DECLARE @TestJudet NVARCHAR(100) = 'Bucuresti'; -- schimba cu un judet real din baza ta
