...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT TOP 1
            ...
            exo.GanglioniLimfatici AS ExamenObiectiv_GanglioniLimfatici,
            ...
            exo.ExamenObiectivDetaliat AS ExamenObiectiv_ExamenObiectivDetaliat,
            exo.AlteObservatiiClinice AS ExamenObiectiv_AlteObservatiiClinice,
            ...
            conc.EsteAfectiuneOncologica AS Concluzii_EsteAfectiuneOncologica,
            conc.DetaliiAfectiuneOncologica AS Concluzii_DetaliiAfectiuneOncologica,
            conc.AreIndicatieInternare AS Concluzii_AreIndicatieInternare,
            conc.TermenInternare AS Concluzii_TermenInternare,
            conc.SaEliberatPrescriptie AS Concluzii_SaEliberatPrescriptie,
            conc.SeriePrescriptie AS Concluzii_SeriePrescriptie,
            conc.SaEliberatConcediuMedical AS Concluzii_SaEliberatConcediuMedical,
            conc.SerieConcediuMedical AS Concluzii_SerieConcediuMedical,
            conc.SaEliberatIngrijiriDomiciliu AS Concluzii_SaEliberatIngrijiriDomiciliu,
            conc.SaEliberatDispozitiveMedicale AS Concluzii_SaEliberatDispozitiveMedicale,
            conc.TransmiterePrinEmail AS Concluzii_TransmiterePrinEmail,
            conc.EmailTransmitere AS Concluzii_EmailTransmitere,
