...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT TOP 1
            ...
            ant.AHC_Mama AS Antecedente_AHC_Mama,
            ant.AHC_Tata AS Antecedente_AHC_Tata,
            ant.AHC_Frati AS Antecedente_AHC_Frati,
            ant.AHC_Bunici AS Antecedente_AHC_Bunici,
            ant.AHC_Altele AS Antecedente_AHC_Altele,
            ant.AF_Nastere AS Antecedente_AF_Nastere,
            ant.AF_Dezvoltare AS Antecedente_AF_Dezvoltare,
            ant.AF_Menstruatie AS Antecedente_AF_Menstruatie,
            ant.AF_Sarcini AS Antecedente_AF_Sarcini,
            ant.AF_Alaptare AS Antecedente_AF_Alaptare,
            ant.APP_BoliCopilarieAdolescenta AS Antecedente_APP_BoliCopilarieAdolescenta,
            ant.APP_BoliAdult AS Antecedente_APP_BoliAdult,
            ant.APP_Interventii AS Antecedente_APP_Interventii,
            ant.APP_Traumatisme AS Antecedente_APP_Traumatisme,
            ant.APP_Transfuzii AS Antecedente_APP_Transfuzii,
            ant.APP_Alergii AS Antecedente_APP_Alergii,
            ant.APP_Medicatie AS Antecedente_APP_Medicatie,
            ant.Profesie AS Antecedente_Profesie,
            ant.ConditiiLocuinta AS Antecedente_ConditiiLocuinta,
            ant.ConditiiMunca AS Antecedente_ConditiiMunca,
            ant.ObiceiuriAlimentare AS Antecedente_ObiceiuriAlimentare,
            ant.Toxice AS Antecedente_Toxice,
        ...
        WHERE (@PacientID IS NULL OR @PacientID = '00000000-0000-0000-0000-000000000000' OR c.PacientID = @PacientID)
          ...
          AND (@ProgramareID IS NULL OR c.ProgramareID = @ProgramareID OR c.ProgramareID IS NULL)
        
        ORDER BY 
          CASE WHEN c.ProgramareID = @ProgramareID THEN 0 ELSE 1 END,  -- Prefer exact match first
          c.DataCreare DESC;
