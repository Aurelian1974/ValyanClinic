...
public class GetPacientByIdQueryHandler : IRequestHandler<GetPacientByIdQuery, Result<PacientDetailDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            {
                Id = pacient.Id,
                Cod_Pacient = pacient.Cod_Pacient ?? string.Empty,
                CNP = pacient.CNP,
                Nume = pacient.Nume,
                Prenume = pacient.Prenume,
                NumeComplet = pacient.NumeComplet ?? string.Empty,
                Data_Nasterii = pacient.Data_Nasterii,
                Varsta = pacient.Varsta,
                Sex = pacient.Sex ?? string.Empty,
                ...
                AdresaCompleta = pacient.AdresaCompleta ?? string.Empty,
